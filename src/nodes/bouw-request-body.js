...
const regels = [
  ...
  '2. Volgorde en terugkeer: klopt de reisvolgorde, en keert een rondreis aan het einde terug naar de vertrekstad (als type "transit") voordat de internationale terugvlucht vertrekt?',
  ...
  'Corrigeer de route op basis van deze drie controles en geef daarna pas het eindresultaat.',
  '',
